        ...
        e = l.Control.extend({
            options: {
                ...
                createButtonCallback(t, i) {
                    const s = l.DomUtil.create("a", "leaflet-bar-part leaflet-bar-part-single", t),
                        o = (s.title = i.strings.title, s.href = "#", s.setAttribute("role", "button"), l.DomUtil.create(i.iconElementTag, i.icon, s));
                    if (void 0 !== i.strings.text) {
                        const e = l.DomUtil.create(i.textElementTag, "leaflet-locate-text", s);
                        e.textContent = i.strings.text, s.classList.add("leaflet-locate-text-active"), s.parentNode.style.display = "flex", 0 < i.icon.length && o.classList.add("leaflet-locate-icon")
                    }
                    return {
                        link: s,
                        icon: o
                ...
                strings: {
                    ...
                    metersUnit: "metros",
                    feetUnit: "feet",
                    popup: "Tu estás aproximadamente a {distance} {unit} al rededor de este punto",
                    ...
                    switch (t = s[t = this._map.getBounds().contains(this._event.latlng) ? i ? s.inView : s.inViewNotFollowing : t] ? s[t] : t) {
                        ...
                        case "stop":
                            if (this.stop(), this.options.returnToPrevBounds) {
                                const o = this.options.flyTo ? this._map.flyToBounds : this._map.fitBounds;
            ...
            _drawMarker() {
                ...
                var i, s = this._event.latlng;
                this.options.drawCircle && (i = this._isFollowing() ? this.options.followCircleStyle : this.options.circleStyle, this._circle ? this._circle.setLatLng(s).setRadius(t).setStyle(i) : this._circle = l.circle(s, t, i).addTo(this._layer));
                let o, e;
                e = this.options.metric ? (o = t.toFixed(0), this.options.strings.metersUnit) : (o = (3.2808399 * t).toFixed(0), this.options.strings.feetUnit), this.options.drawMarker && (i = this._isFollowing() ? this.options.followMarkerStyle : this.options.markerStyle, this._marker ? (this._marker.setLatLng(s), this._marker.setStyle && this._marker.setStyle(i)) : this._marker = new this.options.markerClass(s, i).addTo(this._layer)), this._drawCompass();
